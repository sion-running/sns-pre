...
public class PostControllerTest {
    ...
    @Test
    @WithMockUser
    void 포스트_수정하기() throws Exception {
        String title = "title";
        String body = "body";
    ...
    @Test
    @WithMockUser
    void 포스트_수정시_수정하려는_글이_존재하지_않으면_에러발생() throws Exception {
        String title = "title";
        String body = "body";
    ...
    @Test
    @WithMockUser
    void 포스트_삭제하기() throws Exception {
    ...
    @Test
    @WithMockUser
    void 포스트_삭제시_포스트가_존재하지_않는경() throws Exception {
        // mocking
    ...
    @Test
    @WithMockUser
    void 내_피드목록_조회() throws Exception {
    ...
    @Test
    @WithAnonymousUser
    void 좋아요_클릭시_로그인하지_않은경우() throws Exception {
        when(postService.my(any(), any())).thenReturn(Page.empty());
    ...
    @Test
    @WithMockUser
    void 좋아요_클릭시_게시물이_없는경우() throws Exception {
